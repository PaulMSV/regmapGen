...
+-----------------+------------------+-----------+----------------------------------------------------------+
| ``template``    | ``regmap_sv.j2`` | Имя шаблона (для задания пользовательского шаблона)                  |
+-----------------+------------------+----------------------------------------------------------------------+
...
``template``          ``regmap_md.j2`` Имя шаблона (для задания пользовательского шаблона)
===================== ================ ================================================================
...
``image_dir``         ``regs_img``           Путь к директории, где будут сохранены все изображения
``print_conventions`` ``True``               Включить генерацию таблицы с объяснением режимов доступа к регистру
``template``          ``regmap_asciidoc.j2`` Имя шаблона (для задания пользовательского шаблона)
===================== ====================== ================================================================
